...
export default function PublishingSettings({id}:{id:string}) {
  ...
  return <section className="pub-settings-entry">
    <h2>Gedeeld artikel</h2><p>De formulieren hieronder bewaren het concept. Hoofdstukken, verwijzingen, websiteadressen en publiceren op Meridian of Avera beheer je via het zijpaneel.</p>
