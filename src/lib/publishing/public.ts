...
export const readSharedArticle = (platform: Platform, slug: string) => call<SharedArticle | null>("publishing_article", {p_platform:platform,p_slug:slug},null);
...
export async function readCatalogAll(platform: Platform): Promise<SharedArticle[]> {
